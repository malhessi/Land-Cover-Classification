...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="LDA",
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="NB",
                                                       Overall_Accuracy = acc_nb, Kappa_Index=kappa_nb))
...
```{r Logistic, message=FALSE, warning=FALSE, include=TRUE}
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="Logistic",
                                                       Overall_Accuracy = acc_log, Kappa_Index=kappa_log))
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="KNN",
                                                       Overall_Accuracy = acc_knn, Kappa_Index = kappa_knn))
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="C.Tree",
                                                       Overall_Accuracy = acc_Ctree, Kappa_Index=kappa_Ctree))
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="RF",
                                                       Overall_Accuracy = acc_rf, Kappa_Index=kappa_rf))
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="SVM_Linear",
                                                       Overall_Accuracy = acc_svml, Kappa_Index = kappa_svml))
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="SVM_Radial",
                                                       Overall_Accuracy = acc_svmr, Kappa_Index = kappa_svmr))
...
# Create tibbles to store the results
accuracy_results <- bind_rows(accuracy_results, tibble(model="Ensemble",
                                                       Overall_Accuracy = acc_ensemble, Kappa_Index = kappa_ensemble))
